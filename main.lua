...
local function InitInGameMenu()
    menu = Menu()
    menu:AddItem("Resume game", function()
        game.state = "ingame"
    end)
    menu:AddItem("Return to title", function()
        newGame("menu")
    end)
    menu:AddItem("Quit game", function()
        love.event.quit()
    end)
end
...
function love.keypressed(key, isrepeat)
    ...
    elseif game.state == 'menu' or game.state == 'ingame_menu' then
        menu:keypressed(key, isrepeat)
        if game.state == 'ingame_menu' and key == 'escape' then
            game.state = 'ingame'
        end
...
function love.draw()
    ...
    if game.state == "menu" or game.state == "ingame_menu" then
        love.graphics.push()
